#############################################################################
# Makefile for building: build/trakt-qt
# Generated by qmake (3.1) (Qt 6.11.0)
# Project:  trakt-qt.pro
# Template: app
# Command: /usr/bin/qmake6 -o Makefile trakt-qt.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_NO_DEBUG -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_NETWORKAUTH_LIB -DQT_NETWORK_LIB -DQT_CORE_LIB
CFLAGS        = -pipe -O2 -Wall -Wextra -D_REENTRANT $(DEFINES)
CXXFLAGS      = -pipe -O2 -Wall -Wextra -D_REENTRANT $(DEFINES)
INCPATH       = -I. -I. -I/usr/include/qt6 -I/usr/include/qt6/QtWidgets -I/usr/include/qt6/QtGui -I/usr/include/qt6/QtNetworkAuth -I/usr/include/qt6/QtNetwork -I/usr/include/qt6/QtCore -Ibuild -I/usr/lib64/qt6/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = trakt-qt1.0.0
DISTDIR = /home/cube/playground/trakt-qt/build/trakt-qt1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/usr/lib64 -Wl,-rpath-link,/usr/lib64
LIBS          = $(SUBLIBS) /usr/lib64/libQt6Widgets.so /usr/lib64/libQt6Gui.so /usr/lib64/libGLX.so /usr/lib64/libOpenGL.so /usr/lib64/libQt6NetworkAuth.so /usr/lib64/libQt6Network.so /usr/lib64/libQt6Core.so -lpthread -lGLX -lOpenGL   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = 
...
SOURCES       = main.cpp \
		mainwindow.cpp \
		traktclient.cpp build/moc_mainwindow.cpp \
		build/moc_traktclient.cpp
OBJECTS       = build/main.o \
		build/mainwindow.o \
		build/traktclient.o \
		build/moc_mainwindow.o \
		build/moc_traktclient.o
DIST          = /usr/lib64/qt6/mkspecs/features/spec_pre.prf \
		...
		trakt-qt.pro mainwindow.hpp \
		traktclient.hpp main.cpp \
		mainwindow.cpp \
		traktclient.cpp
QMAKE_TARGET  = trakt-qt
DESTDIR       = build/
TARGET        = build/trakt-qt


first: all
####### Build rules

build/trakt-qt:  $(OBJECTS)  
	@test -d build/ || mkdir -p build/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: trakt-qt.pro /usr/lib64/qt6/mkspecs/linux-g++/qmake.conf /usr/lib64/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt6/mkspecs/common/unix.conf \
		/usr/lib64/qt6/mkspecs/common/linux.conf \
		/usr/lib64/qt6/mkspecs/common/sanitize.conf \
		/usr/lib64/qt6/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.hpp traktclient.hpp $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp traktclient.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: build/moc_mainwindow.cpp build/moc_traktclient.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_mainwindow.cpp build/moc_traktclient.cpp
build/moc_mainwindow.cpp: mainwindow.hpp \
		build/moc_predefs.h \
		/usr/libexec/qt6/moc
	/usr/libexec/qt6/moc $(DEFINES) --include /home/cube/playground/trakt-qt/build/moc_predefs.h -I/usr/lib64/qt6/mkspecs/linux-g++ -I/home/cube/playground/trakt-qt -I/home/cube/playground/trakt-qt -I/usr/include/qt6 -I/usr/include/qt6/QtWidgets -I/usr/include/qt6/QtGui -I/usr/include/qt6/QtNetworkAuth -I/usr/include/qt6/QtNetwork -I/usr/include/qt6/QtCore -I/usr/include/c++/15 -I/usr/include/c++/15/x86_64-suse-linux -I/usr/include/c++/15/backward -I/usr/lib64/gcc/x86_64-suse-linux/15/include -I/usr/local/include -I/usr/lib64/gcc/x86_64-suse-linux/15/include-fixed -I/usr/x86_64-suse-linux/include -I/usr/include mainwindow.hpp -o build/moc_mainwindow.cpp

build/moc_traktclient.cpp: traktclient.hpp \
		build/moc_predefs.h \
		/usr/libexec/qt6/moc
	/usr/libexec/qt6/moc $(DEFINES) --include /home/cube/playground/trakt-qt/build/moc_predefs.h -I/usr/lib64/qt6/mkspecs/linux-g++ -I/home/cube/playground/trakt-qt -I/home/cube/playground/trakt-qt -I/usr/include/qt6 -I/usr/include/qt6/QtWidgets -I/usr/include/qt6/QtGui -I/usr/include/qt6/QtNetworkAuth -I/usr/include/qt6/QtNetwork -I/usr/include/qt6/QtCore -I/usr/include/c++/15 -I/usr/include/c++/15/x86_64-suse-linux -I/usr/include/c++/15/backward -I/usr/lib64/gcc/x86_64-suse-linux/15/include -I/usr/local/include -I/usr/lib64/gcc/x86_64-suse-linux/15/include-fixed -I/usr/x86_64-suse-linux/include -I/usr/include traktclient.hpp -o build/moc_traktclient.cpp
...
build/traktclient.o: traktclient.cpp traktclient.hpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/traktclient.o traktclient.cpp

build/moc_mainwindow.o: build/moc_mainwindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_mainwindow.o build/moc_mainwindow.cpp

build/moc_traktclient.o: build/moc_traktclient.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_traktclient.o build/moc_traktclient.cpp
